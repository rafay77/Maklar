          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className="hero__inner-3">
                <div className="sec-title-wrapper sec-img">
                  {/* <h2 className="sec-sub-title">Digital</h2> */}
                  <h3 className="sec-title title-left" ref={titleLeft} style={{  fontFamily: 'Gruppo' }}>
                    Maklar
                  </h3>
                  <h3 className="sec-title2 title-right" ref={titleRight} style={{  fontFamily: 'Gruppo' }}>
                    Creations
                  </h3>
                </div>
