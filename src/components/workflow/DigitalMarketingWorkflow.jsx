    ...
    <>
      <section className="workflow__area-3">
        <div className="workflow__wrapper-3" ref={workflowWrapper}>
          ...
          <div className="research__area wf_panel pt-120" style={{ marginTop: '0%' }}>
          ...
          <div className="counter__area-3 wf_panel"style={{ marginBottom: '0px' }} >
            <div className="container">
              <div className="row">
                <div className="col-xxl-12">
                  <div className="sec-title-wrapper">
          ...
          {/* CTA area start */}
          <div className="cta__area-3 wf_panel" style={{ marginTop: '0%' }}>
